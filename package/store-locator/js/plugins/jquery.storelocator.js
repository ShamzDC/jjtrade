...
;(function ($, window, document, undefined) {
	...
	var defaults = {
		...
		'dragSearch'                 : false,
		'infowindowTemplatePath'     : 'package/store-locator/js/plugins/templates/infowindow-description.html',
		'listTemplatePath'           : 'package/store-locator/js/plugins/templates/location-list-description.html',
		'KMLinfowindowTemplatePath'  : 'package/store-locator/js/plugins/templates/kml-infowindow-description.html',
		'KMLlistTemplatePath'        : 'package/store-locator/js/plugins/templates/kml-location-list-description.html',
		'listTemplateID'             : null,
