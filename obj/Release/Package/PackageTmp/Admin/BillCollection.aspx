            ...
            <asp:Panel ID="pnlControl" runat="server">
                <div class="col-md-12">
                    <div class="col-md-2">
                        ...
                        <asp:Label ID="Label4" runat="server" Text="Receipt No">
                        </asp:Label>
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="Label3" runat="server" Text="Pay To">
                        </asp:Label>
                    ...
                    <div class="col-md-2">
                        <asp:Label ID="Label5" runat="server" Text="ModeofPay">
                        </asp:Label>
                    ...
                    <asp:GridView ID="GridAllCollection" runat="server" AutoGenerateColumns="false" EmptyDataText="No Data Found"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Payto">
                                <ItemTemplate>
                                    <asp:Label ID="Payto" runat="server" Text='<%#Eval("PaytoEmpID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
