            ...
            <asp:Panel ID="pnlControl" runat="server">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <asp:Label ID="Label8" runat="server" Text="Debit/Credit No"> </asp:Label>
                    ...
                    <div class="form-group">
                        ...
                        <asp:Label ID="Label2" runat="server" Text="Txrn Type"> </asp:Label>
                    ...
                    <div class="form-group">
                        <asp:Label ID="Label1" runat="server" Text="Expenses Type"> </asp:Label>
