...
<head>
    ...
    <style>
    body{
        background-image: url("images/wave-with-abstract-shapes 1.png");
    ...
    .panel-login
    {
        ...
        padding: 29px;
        border-radius: 10px;
         box-shadow: 0px 0px 1px 0px #434343, 4px 4px 8px -5px #434343;
    }
        ...
        <div class="admin-row">
            <div class="panel panel-login shadow-z-1">
                <div class="admin-logo">
                     <img src="images/logo-jj.png" class="img-responsive" alt="logo" /> 
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div id="login-form" role="form" style="display: block;">
                                ...
                                <div class="form-group"><b>Admin/User</b>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12" align="center">
                                            <asp:Button runat="server" class="btn btn-primary btn_width_radius" Text="Login" ID="btnlogin" OnClick="btnlogin_Click">
                                            </asp:Button>
                                        </div>
                                    </div>
                                </div>
