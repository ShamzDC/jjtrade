<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="Client.Admin.AdminLogin" %>
                            ...
                            <div id="login-form" role="form" style="display: block;">
                                <div class="form-group">                                    
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtusername"
                                        ErrorMessage="Enter UserName" class="validation"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
